import { Avatar, Badge, Box, Divider, IconButton, Menu, MenuItem, Typography } from "@material-ui/core";
...
const UserAccount = () => {
  ...
  const latestNotifications = useSelector(state => state.notifications.all.results.slice(0, 4));
  ...
  return (
    <div className={classes.root}>
      <Box display="flex" alignItems="center" justifyContent="flex-start">
        <Avatar variant="rounded" src={currentUser.avatar} className={classes.avatar} />
