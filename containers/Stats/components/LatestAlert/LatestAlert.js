...
const LatestAlert = () => {
  ...
  const { latest: { received = 0, sent = 0 } } = useSelector(state => state.notifications);
  const chartColors = useMemo(() => [theme.palette.promo.main, theme.palette.survey.main], [theme]);
